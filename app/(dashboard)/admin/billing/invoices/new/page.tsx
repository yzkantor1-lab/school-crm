...
export default function NewInvoicePage() {
  ...
  return (
    <div className="max-w-2xl">
      <Link href="/admin/billing" className="flex items-center gap-1 text-slate-500 hover:text-slate-700 text-sm mb-5"><ArrowLeft size={15} /> Back to Billing</Link>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex gap-3">
          ...
          <Link href="/admin/billing" className="text-sm text-slate-600 hover:text-slate-900 px-4 py-2.5 rounded-lg border border-slate-200 hover:bg-slate-50 transition">Cancel</Link>
        </div>
      </form>
    </div>
  )
